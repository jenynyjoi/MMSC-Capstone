...
<aside id="sidebar" class="sidebar-transition fixed inset-y-0 left-0 z-50 w-64 lg:static flex flex-col bg-white dark:bg-dark-card border-r border-slate-100 dark:border-dark-border">
  ...
  <nav class="flex-1 overflow-y-auto no-scrollbar px-3 py-3 space-y-0.5">
    ...
    <a href="{{ route('teacher.my-subjects') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-blue-50 hover:text-[#0d4c8f] dark:hover:bg-[#0d4c8f]/10 dark:hover:text-blue-300 transition-all">
      <iconify-icon icon="solar:notebook-bold" width="18" class="shrink-0 text-slate-400 group-hover:text-[#0d4c8f]"></iconify-icon>
      My Assigned Subjects
    </a>
