    ...
    <header>
        <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm border-b border-slate-100 dark:border-slate-800 transition-all duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <a href="{{ url('/') }}" class="flex items-center gap-3 group">
                        <img src="{{ asset('public/images/full-logo.jpg') }}" alt="Logos" class="rounded-lg">
            ...
            <div x-show="mobileMenu"
                ...
                <a href="#" class="block px-3 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-lg transition-colors">Home</a>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" class="pl-4 mt-1 space-y-1">
                        @foreach(['Requirements', 'Enrollment Process', 'Online Application'] as $item)
                            <a href="#" class="block px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-lg transition-colors">{{ $item }}</a>
                        @endforeach
                    </div>
                </div>
